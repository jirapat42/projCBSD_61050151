 ...
 * @author 61050151
 */
public class removedvdcartcontroller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name = request.getParameter("Dvdname");
        HttpSession session = request.getSession();
        EntityManager em = (EntityManager) session.getAttribute("entitymanager");
        Dvdcart emp = DvdcartTable.findDvdByNamedvd(em, name);
        session.setAttribute("dvdcart", emp);
